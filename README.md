# go-mutesting [![GoDoc](https://godoc.org/github.com/JekaMas/go-mutesting?status.png)](https://godoc.org/github.com/JekaMas/go-mutesting) [![Build Status](https://travis-ci.org/JekaMas/go-mutesting.svg?branch=master)](https://travis-ci.org/JekaMas/go-mutesting) [![Coverage Status](https://coveralls.io/repos/avito-tech/go-mutesting/badge.png?branch=master)](https://coveralls.io/r/avito-tech/go-mutesting?branch=master)
